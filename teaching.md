...
- Faculty of Economics, Kansai University
  - 2026
    - Supplementary Lectures for "Introduction to Microeconomics 1", Spring Semester (undergraduate level).
    - Supplementary Lectures for "Introduction to Microeconomics 2", Fall Semester (undergraduate level).
  - 2025
    - Supplementary Lectures for "Introduction to Microeconomics 1", Spring Semester (undergraduate level).
    - Supplementary Lectures for "Introduction to Microeconomics 2", Fall Semester (undergraduate level).
